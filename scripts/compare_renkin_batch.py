        ...
        if route is None:
            base["tool_specific"] = {
                "renkin": {
                    ...
                    "stock_lookup_cache_hits": result["stock_lookup_cache_hits"],
                    "stock_lookup_cache_misses": result["stock_lookup_cache_misses"],
                    "stock_lookup_positive_results": result["stock_lookup_positive_results"],
                    ...
                    "sa_precompute_molecules": result.get("sa_precompute_molecules"),
