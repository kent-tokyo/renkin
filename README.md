...
| **Constraint DSL** | `--constraints constraints.json` — element filters, step/cost limits, confidence thresholds, preferred reaction families; enables LLM → RENKIN pipelines |
...
| `plan_with_constraints` | Constraint-DSL planning (element filters, step/cost limits, confidence thresholds) |
